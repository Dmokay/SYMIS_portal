<div class="side-content-wrap">
    <div class="sidebar-left open rtl-ps-none" data-perfect-scrollbar data-suppress-scroll-x="true">
        <ul class="navigation-left">
            ...
            <li class="nav-item " data-item="sessions">
                <a class="nav-item-hold" href="{{url('http://gull-html-laravel.ui-lib.com/test.html')}}">
            ...
            <li class="nav-item">
                <a class="nav-item-hold" href="{{url('http://demos.ui-lib.com/gull-html-doc/')}}" target="_blank">
    ...
    <div class="sidebar-left-secondary rtl-ps-none" data-perfect-scrollbar data-suppress-scroll-x="true">
        ...
        <ul class="childNav" data-parent="dashboard">
            <li class="nav-item ">
                <a class=""
                    href="{{url('dashboard/dashboard1.html')}}">
        ...
        <ul class="childNav" data-parent="apps">
            ...
            <li class="nav-item dropdown-sidemenu">
                ...
                <ul class="submenu">
                    ...
                    <li>
                        <a class=""
                            href="apps/contacts/contact-details.html">
